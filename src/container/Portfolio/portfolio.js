    ...
    return (
      <div>
        ...
        <div style={{ textAlign: 'left', marginBottom: '25px' }}>
          Photo by 
          <a href="https://www.pexels.com/@belart84">
            Artem Beliaikin
          </a> from <a href="https://www.pexels.com/">Pexels</a>{' '}
        </div>
        ...
        <Container className="pdot" text>
          ...
          <p style={{ fontSize: '1.2em' }}>
            A collection of projects I did as a student.
          </p>
        </Container>
                ...
                <div className="image__overlay image__overlay--blur">
                  <div style={{ padding: '20px' }}>
                    ...
                    <p>
                      ...
                      and deleting employee information. Made using: Node.js,
                      Inquirer, mySQL, mySQL Workbench, and ESLint.
                    </p>
                    <p>
              ...
              <div className="pic">
                ...
                <div className="image__overlay image__overlay--blur">
                  <div style={{ padding: '20px' }}>
                    ...
                    <p>Made using: Node.js, Axios, Dotenv, and Inquirer.</p>
                    <br></br>
              ...
              <div className="pic">
                ...
                <div className="image__overlay image__overlay--blur">
                  <div style={{ padding: '20px' }}>
                    ...
                    <p>
                      {' '}
                      A web application that allows a user to plan their
                      workday. A web application that allows a user to create
              ...
              <div className="pic">
                ...
                <div className="image__overlay image__overlay--blur">
                  <div style={{ padding: '20px' }}>
                    ...
                    <br></br>
                    <p>A web application that lists employee information.</p>
                    <p>
                      Made using: React, Random User Generator API, and Heroku.
                    </p>
                    <br></br>
                    <a
                      href="https://fanueled.herokuapp.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <i
...
<i style={{color:'white'}}className="fab fa-github github"></i>
        ...
        <Segment style={{ padding: '6em 0em' }} vertical>
          <Container text>
            ...
            <br></br>
            <p style={{ fontSize: '1.2em' }}>
              Reach out and say hi or connect with me. I look forward to hearing
              from you.
            </p>
            <br></br>
